...
const COMPONENTS = {
  ...
  cientifica: ScientificCalculator,
  porcentajes: PercentageCalculator,
  propinas: TipCalculator,
  unidades: UnitConverter,
  descuentos: DiscountCalculator,
  imc: BMICalculator,
  hipoteca: MortgageCalculator,
  prestamos: LoanCalculator,
  'interes-compuesto': CompoundInterestCalculator,
  divisas: CurrencyCalculator,
  estadisticas: StatisticsCalculator,
  matrices: MatrixCalculator,
  programador: ProgrammerCalculator,
  fechas: DateCalculator,
  geometria: GeometryCalculator,
  combustible: FuelCalculator,
  calorias: CalorieCalculator,
  irpf: IRPFCalculator,
  financiera: FinancialCalculator,
}
